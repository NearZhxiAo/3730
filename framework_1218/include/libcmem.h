 ...
 *
 * Buffer allocation is tracked at the process level by way of a 'process
 ...
 * explicitly freed/unregistered its buffers, they get automatically
 * unregistered (and freed when no more registered processes exist).  Only
 * when the last registered process frees a buffer (either explictily, or
 * by auto-cleanup) does a buffer actually get freed back to the kernel module.
 *
...
#ifndef __LIB_CMEM_H__
#define __LIB_CMEM_H__
...
#endif
/*
 *  @(#) ti.sdo.linuxutils.cmem; 2, 2, 0,104; 4-20-2009 11:43:31; /db/atree/library/trees/linuxutils/linuxutils-d06x/src/
 */
