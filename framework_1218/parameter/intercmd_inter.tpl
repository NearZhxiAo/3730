...
parameter = {
	...
	cmd_name = [+ (sprintf "%s%s " "[" "+")  +](get "cmd_name")[+ (sprintf " %s%s" "+" "]") +];
...
[+ (sprintf "%s%s%s " "[" "+" " IF (exist?")  +]"rt_in_type"[+ (sprintf ") %s%s" "+" "]")  +][+ (sprintf "%s%s%s " "[" "+" " IF ")  +](string-length (get "rt_in_type"))[+ (sprintf " %s%s" "+" "]")  +]	rt_in_type = [+ (sprintf "%s%s " "[" "+")  +](get "rt_in_type")[+ (sprintf " %s%s" "+" "]")  +];[+ (sprintf "%s%s%s" "[" "+" " ELSE")  +][+ (sprintf " %s%s" "+" "]")  +][+ (sprintf "%s%s " "[" "+")  +](error (sprintf "rt_in_type for %s not specified!" (get "cmd_name")) )[+ (sprintf " %s%s" "+" "]") +][+ (sprintf "%s%s%s" "[" "+" " ENDIF")  +][+ (sprintf " %s%s" "+" "]")  +][+ (sprintf "%s%s%s" "[" "+" " ENDIF")  +][+ (sprintf " %s%s" "+" "]")  +]
[+ (sprintf "%s%s%s " "[" "+" " IF (exist?")  +]"rt_out_type"[+ (sprintf ") %s%s" "+" "]")  +][+ (sprintf "%s%s%s " "[" "+" " IF ")  +](string-length (get "rt_out_type"))[+ (sprintf " %s%s" "+" "]")  +]	rt_out_type = [+ (sprintf "%s%s " "[" "+")  +](get "rt_out_type")[+ (sprintf " %s%s" "+" "]")  +];[+ (sprintf "%s%s%s" "[" "+" " ELSE")  +][+ (sprintf " %s%s" "+" "]")  +][+ (sprintf "%s%s " "[" "+")  +](error (sprintf "rt_out_type for %s not specified!" (get "cmd_name")) )[+ (sprintf " %s%s" "+" "]") +][+ (sprintf "%s%s%s" "[" "+" " ENDIF")  +][+ (sprintf " %s%s" "+" "]")  +][+ (sprintf "%s%s%s" "[" "+" " ENDIF")  +][+ (sprintf " %s%s" "+" "]")  +]
...
[+ (sprintf "%s%s%s " "[" "+" " IF (exist?")  +]"var_type"[+ (sprintf ") %s%s" "+" "]")  +][+ (sprintf "%s%s%s " "[" "+" " IF ")  +](string-length (get "var_type"))[+ (sprintf " %s%s" "+" "]")  +]	var_type = [+ (sprintf "%s%s " "[" "+")  +](get "var_type")[+ (sprintf " %s%s" "+" "]")  +];[+ (sprintf "%s%s%s" "[" "+" " ELSE")  +][+ (sprintf " %s%s" "+" "]")  +][+ (sprintf "%s%s " "[" "+")  +](error (sprintf "var_type for %s not specified!" (get "cmd_name")) )[+ (sprintf " %s%s" "+" "]") +][+ (sprintf "%s%s%s" "[" "+" " ENDIF")  +][+ (sprintf " %s%s" "+" "]")  +]
...
[+ (sprintf "%s%s%s " "[" "+" " ELIF (exist?")  +]"float_type"[+ (sprintf ") %s%s" "+" "]")  +]	float_type[+ (sprintf "%s%s%s " "[" "+" " IF ")  +](string-length (get "float_type"))[+ (sprintf " %s%s" "+" "]")  +] = [+ (sprintf "%s%s " "[" "+")  +](get "float_type")[+ (sprintf " %s%s" "+" "]")  +][+ (sprintf "%s%s%s" "[" "+" " ENDIF")  +][+ (sprintf " %s%s" "+" "]")  +];
[+ (sprintf "%s%s%s " "[" "+" " ELSE")  +][+ (sprintf " %s%s" "+" "]")  +][+ (sprintf "%s%s " "[" "+")  +](error (sprintf "%s type not specified" (get "cmd_name")))[+ (sprintf " %s%s" "+" "]")  +][+ (sprintf "%s%s%s" "[" "+" " ENDIF")  +][+ (sprintf " %s%s" "+" "]")  +]
