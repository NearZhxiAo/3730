...
enum paracmd_indicator_type {
	...
	PARACMD_AVENC_AVENC_TO_QT_MSG = (CMD_CATEGORY_AVENC << MAX_CATEGORY_BITDEF) + 6,
	...
	PARACMD_QT_QT_TO_AVENC_JPEG_PIC = (CMD_CATEGORY_QT << MAX_CATEGORY_BITDEF) + 3,
	PARACMD_QT_QT_TO_AVENC_START_ENC = (CMD_CATEGORY_QT << MAX_CATEGORY_BITDEF) + 4,
	PARACMD_QT_QT_TO_AVENC_STOP_ENC = (CMD_CATEGORY_QT << MAX_CATEGORY_BITDEF) + 5,
	PARACMD_QT_QT_TO_SERIAL_MEASURE = (CMD_CATEGORY_QT << MAX_CATEGORY_BITDEF) + 6,
	PARACMD_QT_QT_TO_STORAGE_START_LOOPBACK = (CMD_CATEGORY_QT << MAX_CATEGORY_BITDEF) + 7,
	PARACMD_QT_QT_TO_STORAGE_STOP_LOOPBACK = (CMD_CATEGORY_QT << MAX_CATEGORY_BITDEF) + 8,
	PARACMD_QT_QT_TO_STORAGE_CHECK_FILE_LIST = (CMD_CATEGORY_QT << MAX_CATEGORY_BITDEF) + 9,
	PARACMD_QT_QT_TO_STORAGE_PAUSE_LOOPBACK = (CMD_CATEGORY_QT << MAX_CATEGORY_BITDEF) + 10
	,PARACMD_END
};
...
static inline void produce_paracmd_value(void)
{
	...
	printf("PARACMD_AVENC_AVENC_TO_QT_MSG = 0x%x,", PARACMD_AVENC_AVENC_TO_QT_MSG);
	printf("      /* %s */         \n",  "");
	...
	printf("PARACMD_QT_QT_TO_AVENC_JPEG_PIC = 0x%x,", PARACMD_QT_QT_TO_AVENC_JPEG_PIC);
	printf("      /* %s */         \n",  "");
	
	printf("PARACMD_QT_QT_TO_AVENC_START_ENC = 0x%x,", PARACMD_QT_QT_TO_AVENC_START_ENC);
	printf("      /* %s */         \n",  "");
	
	printf("PARACMD_QT_QT_TO_AVENC_STOP_ENC = 0x%x,", PARACMD_QT_QT_TO_AVENC_STOP_ENC);
	printf("      /* %s */         \n",  "");
...
enum paracmd_sendto_type {
	...
	AVENC_AVENC_TO_QT_MSG_SENDTO_DEST =  (1 << UNIX_QT )  ,
	...
	QT_QT_TO_AVENC_JPEG_PIC_SENDTO_DEST =  (1 << UNIX_AVENC )  ,
	QT_QT_TO_AVENC_START_ENC_SENDTO_DEST =  (1 << UNIX_AVENC )  ,
	QT_QT_TO_AVENC_STOP_ENC_SENDTO_DEST =  (1 << UNIX_AVENC )  ,
...
enum paracmd_sendto_flag_type {
	...
	AVENC_AVENC_TO_QT_MSG_SENDTO_FLAG = 0,
	...
	QT_QT_TO_AVENC_JPEG_PIC_SENDTO_FLAG = 0,
	QT_QT_TO_AVENC_START_ENC_SENDTO_FLAG = 0,
	QT_QT_TO_AVENC_STOP_ENC_SENDTO_FLAG = 0,
...
static  Paracmd_Sendto_array paracmd_sendto_array[]={
   ...
   { PARACMD_AVENC_AVENC_TO_STORAGE_STOP_STORAGE,
	...
	,
   { PARACMD_AVENC_AVENC_TO_QT_MSG,
	 AVENC_AVENC_TO_QT_MSG_SENDTO_DEST,
	 AVENC_AVENC_TO_QT_MSG_SENDTO_FLAG
	}
	,
   ...
   { PARACMD_QT_QT_TO_AVENC_INPUT_CCD,
	...
	,
   { PARACMD_QT_QT_TO_AVENC_JPEG_PIC,
	 QT_QT_TO_AVENC_JPEG_PIC_SENDTO_DEST,
	 QT_QT_TO_AVENC_JPEG_PIC_SENDTO_FLAG
	}
	,
   { PARACMD_QT_QT_TO_AVENC_START_ENC,
	 QT_QT_TO_AVENC_START_ENC_SENDTO_DEST,
	 QT_QT_TO_AVENC_START_ENC_SENDTO_FLAG
	}
	,
   { PARACMD_QT_QT_TO_AVENC_STOP_ENC,
	 QT_QT_TO_AVENC_STOP_ENC_SENDTO_DEST,
	 QT_QT_TO_AVENC_STOP_ENC_SENDTO_FLAG
	}
	,
