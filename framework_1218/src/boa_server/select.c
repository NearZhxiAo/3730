...
extern int IsBoaSysQuit;

void select_loop(int server_s)
{

   // printf("entering select_loop....\n");
...
//	    printf("FILE: %s, LINE: %d. server_s = %d, max_fd = %d.\r\n", __FILE__, __LINE__, server_s, max_fd);
