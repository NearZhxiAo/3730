...
static int system_deviceinfo(request *req, node_t *node)
{
	...
	//fprintf(stderr,"\r\n After deviceinfo handler function with status : %d\n",req->status_code);
	//fprintf(stderr,"\r\n Response XML String Content: \n");
	//for (i=0;i <= req->xmllen ;i++ )
	// fprintf(stderr,"%c",*req->xmlstr++);			
...
int streaming_build_tree(node_t *parent)
{
    ...
    for(c = 0; c < get_channel_count(); c++) {
	get_channel_url(c, idstr);
	node = add_node(ch_node, idstr, M_GET | M_PUT, NODE_RESOURCE, "1.0", &streaming_channels_id);
...
HTTP_URI HttpUri [] =
{
   ...
   // {"/ess.htm"                 ,NULL                   ,AUTHORITY_OPERATOR ,URI_FLAG_NEED_PARSE   ,NULL }£¬
    ...
    {"/imgcoder.htm"            ,NULL			,AUTHORITY_OPERATOR ,URI_FLAG_NEED_PARSE   ,NULL },
};    
...
#ifdef FY
		//	printf("entering http_uri_search....!\n");
#endif
...
PSIA_URI PsiaUri [] =
{
    ...
    {"/PSIA/System/upgradeFirmware"	   ,system_updatefirmware     ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL },
    ...
    {"/PSIA/System/time/ntpServers/ID" ,system_time_ntpservers_id ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL },
    ...
    {"/PSIA/System/Network/interfaces/ID"	         ,system_network_interfaces_id	         ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL },    
    {"/PSIA/System/Network/interfaces/ID/ipAddress"	 ,system_network_interfaces_id_ipaddress ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL }, 
    {"/PSIA/System/Network/interfaces/ID/discovery"  ,system_network_interfaces_id_discovery ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL }, 
    ...
    {"/PSIA/System/Video/inputs/channels/ID"	     ,system_video_channels_id     ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL },
    {"/PSIA/System/Video/inputs/channels/ID/overlays"	         ,system_video_channels_id_overlays            ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL },
    {"/PSIA/System/Video/inputs/channels/ID/privacyMask"	     ,system_video_channels_id_privacymask         ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL },
    {"/PSIA/System/Video/inputs/channels/ID/overlays/text"	     ,system_video_channels_id_overlays_text       ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL },
    {"/PSIA/System/Video/inputs/channels/ID/overlays/image"	     ,system_video_channels_id_overlays_image      ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL },
    {"/PSIA/System/Video/inputs/channels/ID/overlays/text/ID"	 ,system_video_channels_id_overlays_text_id    ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL },
    {"/PSIA/System/Video/inputs/channels/ID/overlays/image/ID"	 ,system_video_channels_id_overlays_image_id   ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL },
    ...
    {"/PSIA/System/Audio/channels/ID"   ,system_audio_channels_id      ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL },
    ...
    {"/PSIA/Security/users/ID"	   ,security_aaa_users_id	  ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL },
    ...
    {"/PSIA/Streaming/channels/ID"	                   ,streaming_channels_id                  ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL }, 
    {"/PSIA/Streaming/channels/ID/status"	           ,streaming_channels_id_status           ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL }, 
    {"/PSIA/Streaming/channels/0/http"	               ,streaming_channels_id_http	           ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL },
    {"/PSIA/Streaming/channels/ID/picture"	           ,streaming_channels_id_picture               ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL }, 
    {"/PSIA/Streaming/channels/ID/http/capabilities"    ,streaming_channels_id_http_capabilities    ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL }, 
    {"/PSIA/Streaming/channels/ID/picture/capabilities" ,streaming_channels_id_picture_capabilities ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL },
    ...
    {"/PSIA/Custom/Event/triggers/ID"                  ,custom_event_triggers_id                  ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL }, 
    {"/PSIA/Custom/Event/triggers/ID/notifications"    ,custom_event_triggers_id_notifications    ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL }, 
    {"/PSIA/Custom/Event/triggers/ID/notifications/ID" ,custom_event_triggers_id_notifications_id ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL }, 
    ...
    {"/PSIA/Custom/Event/notification/mailing/ID"      ,custom_event_notification_mailing_id      ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL }, 
    {"/PSIA/Custom/Event/notification/ftp/ID"          ,custom_event_notification_ftp_id          ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL }, 
    {"/PSIA/Custom/Event/notification/httpHost/ID"     ,custom_event_notification_httpHost_id     ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL },
    {"/PSIA/Custom/Analytics"                               ,custom_analytics                                ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL }, 
    {"/PSIA/Custom/Analytics/motionDetection"               ,custom_analytics_motiondetection                ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL }, 
    {"/PSIA/Custom/Analytics/motionDetection/ID"            ,custom_analytics_motiondetection_id             ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL }, 
    {"/PSIA/Custom/Analytics/motionDetection/ID/regions"    ,custom_analytics_motiondetection_id_regions     ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL }, 
    {"/PSIA/Custom/Analytics/motionDetection/ID/regions/ID" ,custom_analytics_motiondetection_id_regions_id  ,AUTHORITY_VIEWER   ,PSIA_URI_FLAG_VIRTUAL_PAGE   ,NULL }, 	
};    
...
#define HEX(x) (((x)>9)?(('a'-10)+(x)):('0'+(x)))
	...
	*ap = '\0';
    ...
    conn->fd = fd;
    conn->status = READ_HEADER; //a new conn will be seted as READ_HEADER
...
int process_logline(request * req)
{
    ...
    if (!memcmp(req->logline, "GET ", 4))
      ...
      req->method = M_HEAD;
    else if (!memcmp(req->logline, "PUT ", 5))        //psia
      req->method = M_PUT;
    else if (!memcmp(req->logline, "POST ", 5))
      req->method = M_POST;
    else if (!memcmp(req->logline, "DELETE ", 7))     //psia
      req->method = M_DELETE;
    else {
	log_error_time();
...
{ 
    ...
    //fprintf(stderr,"\r\nAfter unescape_uri with request_uri: %s, query_string: %s\n",req->request_uri,req->query_string);
    /* clean pathname */
...
//		printf("translate_uri(req) == 0\n");
	SQUASH_KA(req);
	return 0;               /* failure, close down */
    }
#ifdef DAVINCI_IPCAM
    req->authority = 0;
//printf("translate_uri ok!\nenter the authority process!\n");
//#if 0
    if (req->http_uri) {
	//if(req->http_uri->authority < rq->authority)
#if 0	
#ifdef ISLAB      //2010-08-22
	...
	inbuf = malloc(req->content_length+RDBFLEN);
	/* allocate a buffer for the input xml block */
	if(req->content_length > 0) {
	    while ((red = read(0, inbuf+total, RDBFLEN))) 
	    {
		if (red < 0) {
		    fprintf(stderr,"Only read %d of %d: read error - %m<br>", total, req->content_length);
		    break;
		}
		total += red;
	...
	if (req->psia_uri->handler) {	        
	    //fprintf(stderr,"\r\n Inside process_header_end psia handler\n");
...
#endif
#ifdef ISLAB_DEBUG
    printf("before enter create_temporary .....\n");
#endif
    if (req->method == M_POST) {
	req->post_data_fd = create_temporary_file(1, NULL, 0);
#ifdef ISLAB_DEBUG
	printf("enter create_temp....\n");
#endif
