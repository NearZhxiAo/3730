...
/*___________________________________________________________________________
 ...
 |   Purpose :                                                               |
 |                                                                           |
 |    Performs the addition (var1+var2) with cgOverflow control and saturation;|
 |    the 16 bit result is set at +32767 when cgOverflow occurs or at -32768   |
...
/*___________________________________________________________________________
 ...
 |   Purpose :                                                               |
 |                                                                           |
 |    Performs the subtraction (var1+var2) with cgOverflow control and satu-   |
 |    ration; the 16 bit result is set at +32767 when cgOverflow occurs or at  |
...
/*___________________________________________________________________________
 ...
 |   Caution :                                                               |
 |                                                                           |
 |    In some cases the cgCarry flag has to be cleared or set before using     |
...
/*___________________________________________________________________________
 ...
 |   nerate cgCarry and cgOverflow values :                                      |
...
/*___________________________________________________________________________
 ...
 |   cgOverflow control and saturation; the result is set at +2147483647 when  |
 |   cgOverflow occurs or at -2147483648 when underflow occurs.                |
 |                                                                           |
 |   Complexity weight : 2                                                   |
 |                                                                           |
 |   Inputs :                                                                |
...
/*___________________________________________________________________________
 ...
 |   with cgCarry. No saturation. Generate cgCarry and cgOverflow values. The car- |
 |   ry and cgOverflow values are binary variables which can be tested and as- |
 |   signed values.                                                          |
 |                                                                           |
 |   Complexity weight : 2                                                   |
 |                                                                           |
...
Word32 L_add_c (Word32 L_var1, Word32 L_var2)
{
    ...
    L_var_out = L_var1 + L_var2 + cgCarry;
...
/*___________________________________________________________________________
 ...
 |   Purpose :                                                               |
 |                                                                           |
 |   Performs 32 bits subtraction of the two 32 bits variables with cgCarry    |
 |   (borrow) : L_var1-L_var2-C. No saturation. Generate cgCarry and cgOverflow  |
 |   values. The cgCarry and cgOverflow values are binary variables which can    |
...
/*___________________________________________________________________________
 ...
 |   Purpose :                                                               |
 |                                                                           |
 |    32 bit L_var1 is set to 2147483647 if an cgOverflow occured or to        |
 |    -2147483648 if an underflow occured on the most recent L_add_c,        |
 |    L_sub_c, L_macNs or L_msuNs operations. The cgCarry and cgOverflow values  |
