...
)
{
    ...
    if (bfi != 0)                               /* if bad frame */
    {
        ...
        for (i = 0; i < M; i++)
        {
            ...
            temp = add (mean_lsf_5[i], mult (st->past_r_q[i],
                                           LSP_PRED_FAC_MR122));
        ...
        /* if good LSFs received */
    {
        ...
        p_dico = &dico1_lsf_5[shl (indice[0], 2)];
        lsf1_r[0] = *p_dico++;                   
        lsf1_r[1] = *p_dico++;                   
        lsf2_r[0] = *p_dico++;                   
        lsf2_r[1] = *p_dico++;                   

        p_dico = &dico2_lsf_5[shl (indice[1], 2)];
        lsf1_r[2] = *p_dico++;                   
        lsf1_r[3] = *p_dico++;                   
        lsf2_r[2] = *p_dico++;                   
        lsf2_r[3] = *p_dico++;                   
        ...
        p_dico = &dico4_lsf_5[shl (indice[3], 2)]; 
        lsf1_r[6] = *p_dico++;                   
        lsf1_r[7] = *p_dico++;                   
        lsf2_r[6] = *p_dico++;                   
        lsf2_r[7] = *p_dico++;                   

        p_dico = &dico5_lsf_5[shl (indice[4], 2)]; 
        lsf1_r[8] = *p_dico++;                   
        lsf1_r[9] = *p_dico++;                   
        lsf2_r[8] = *p_dico++;                   
        lsf2_r[9] = *p_dico++;                   
