...
static Display_Handle Display_init(DisplayAttr *attr)
{
	struct v4l2_format         fmt;
...
static int Display_get(Display_Handle phandle, DisplayBuffer *buffer)
{
...
static int Display_put(Display_Handle phandle, DisplayBuffer *buffer)
{
...
static int Display_destroy(Display_Handle phandle)
{
	int index;
