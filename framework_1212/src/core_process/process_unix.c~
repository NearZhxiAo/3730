...
static succeed_type process_unix_deal(CORE_PROCESS_PRIVATE_HANDLE *phandle, UNIX_CMD_STRUCT *pcmd)
{
    int status;
...
succeed_type process_unix(CORE_PROCESS_PRIVATE_HANDLE *phandle)
{
    ...
    process_unix_deal(phandle, &unix_rcv_cmd);
